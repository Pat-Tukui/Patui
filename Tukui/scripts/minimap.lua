...
TukuiDB.CreatePanel(TukuiMinimap, 144, 142, "CENTER", Minimap, "CENTER", -0, 1)
...
Minimap:SetPoint("BOTTOMRIGHT", UIParent, "BOTTOMRIGHT", TukuiDB.Scale(-5), TukuiDB.Scale(26))
Minimap:SetSize(TukuiDB.Scale(144), TukuiDB.Scale(143))
