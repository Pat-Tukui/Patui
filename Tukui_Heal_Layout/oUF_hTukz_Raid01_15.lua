...
oUF:Factory(function(self)
	...
	raid:SetPoint("BOTTOM", TukuiActionBarBackground, "TOP", 15, -300*TukuiDB.raidscale)
	...
	RaidMove:SetScript("OnEvent", function(self)
		if InCombatLockdown() then
			...
			elseif numraid > 5 and numraid <= 10 then
				raid:SetPoint('TOP', TukuiActionBarBackground, 15, -260*TukuiDB.raidscale)
				for i,v in ipairs(pets) do v:Disable() end
			elseif numraid > 10 and numraid <= 15 then
				raid:SetPoint('TOP', TukuiActionBarBackground, 16, -170*TukuiDB.raidscale)
				for i,v in ipairs(pets) do v:Disable() end
